          ...
          <div class="card card-body bg-light mt-3">
            ...
            <form class="mt-3" >
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                  <input type="text" readonly value="<?php echo $etunimi; ?>" 
                  name="etunimi" class="form-control" id="inputEtunimi">
                </div>
              </div>
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                  ...
                  value="<?php echo $sukunimi; ?>"  name="sukunimi" class="form-control"  id="inputSukunimi">
                </div>
              </div>
