<?php
  ...
  if(!empty($_POST)){
      ...
      if(empty($henkilotunnus)){
        ...
        if(tarkistaHenkilotunnus($henkilotunnus) === false){
          $henkilotunnusError = "Tunnus oli virheellinen";
          $valid = false;
        }
      }
      ...
      if($valid){
        ...
        $sql = "INSERT INTO asiakas (henkilotunnus, etunimi, sukunimi, lahiosoite, postinumero, postitoimipaikka, sahkoposti, puhelin) 
            ...
            <form action="lisaa_asiakas.php" method="POST" class="mt-3" >
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                  ...
                  name="etunimi" class="form-control 
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                  <input type="text" 
                  value="<?php echo (!empty($sukunimi))?$sukunimi:''; ?>"  name="sukunimi" class="form-control <?php echo (!empty($sukunimiError))?'is-invalid':''; ?>"  id="inputSukunimi">
